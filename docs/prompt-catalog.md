...
- Tags: figma, ui-review, usability, accessibility, design
- Variables: design_context, review_focus, target_users
- Output format: `json`
- Eval checks: valid_json_output, no_ai_disclaimer, compact_response
